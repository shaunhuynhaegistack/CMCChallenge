...
const RULES: Rule[] = [
  {
    ...
    // The one legitimate delay - the backoff between polling attempts - carries
    // an inline allowance instead of a whole-file exemption, so it stays visible
    // in review rather than disappearing into this list.
  },
  {
